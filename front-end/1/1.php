...
<head>
    ...
    <?php
        ...
        $less = new lessc;
        $less->compileFile('public/less/module-1.less', 'public/css/module-1.css');
        ?>
    <link href="public/css/module-1.css" rel="stylesheet" type="text/css" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="menu-dropdown border-end pe-3">
                                        <span class = "py-4">USD<i class="fa-solid fa-angle-down ps-2"></i> </span>
                                ...
                                <div class="menu-dropdown pe-3">
                                        <span class = "py-4">English<i class="fa-solid fa-angle-down ps-2"></i> </span>
                                        <div class="border-end"> </div>
                                        <div class="dropdown-content mt-3">
                                            <a href="#" >English</a>
                                            <hr>
