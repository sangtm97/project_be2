...
<head>
    ...
    <?php
        ...
        $less = new lessc;
        $less->compileFile('public/less/module-12.less', 'public/css/module-12.css');
        ?>
    <link href="public/css/module-12.css" rel="stylesheet" type="text/css" />
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                    <div class="card-product">
                        <div class="card-product-img">
                            <img class="card-img-top card-product-front" src="public/images/product-1-1.jpg" alt="Card image cap">
                            <img class="card-img-top card-product-back" src="public/images/product-1-2.jpg" alt="Card image cap">
                        </div>
            ...
            <div class="col-md-3">
                    <div class="card-product">
                        <div class="card-product-img">
                            <img class="card-img-top card-product-front" src="public/images/product-2-1.jpg" alt="Card image cap">
                            <img class="card-img-top card-product-back" src="public/images/product-2-2.jpg" alt="Card image cap">
            ...
            <div class="col-md-3">
                    <div class="card-product">
                        <div class="card-product-img">
                            <img class="card-img-top card-product-front" src="public/images/product-3-1.jpg" alt="Card image cap">
                            <img class="card-img-top card-product-back" src="public/images/product-3-2.jpg" alt="Card image cap">
                        </div>
            ...
            <div class="col-md-3">
                    <div class="card-product">
                        <div class="card-product-img">
                            <img class="card-img-top card-product-front" src="public/images/product-4-1.jpg" alt="Card image cap">
                            <img class="card-img-top card-product-back" src="public/images/product-4-2.jpg" alt="Card image cap">
            ...
            <div class="col-md-3">
                    <div class="card-product">
                        <div class="card-product-img">
                            <img class="card-img-top card-product-front" src="public/images/product-5-1.jpg" alt="Card image cap">
                            <img class="card-img-top card-product-back" src="public/images/product-5-2.jpg" alt="Card image cap">
                        </div>
                        <div class="product-bage-sales">
            ...
            <div class="col-md-3">
                    <div class="card-product">
                        <div class="card-product-img">
                            <img class="card-img-top card-product-front" src="public/images/product-6-1.jpg" alt="Card image cap">
                            <img class="card-img-top card-product-back" src="public/images/product-6-2.jpg" alt="Card image cap">
            ...
            <div class="col-md-3">
                    <div class="card-product">
                        <div class="card-product-img">
                            <img class="card-img-top card-product-front" src="public/images/product-7-1.jpg" alt="Card image cap">
                            <img class="card-img-top card-product-back" src="public/images/product-7-2.jpg" alt="Card image cap">
            ...
            <div class="col-md-3">
                    <div class="card-product">
                        <div class="card-product-img">
                            <img class="card-img-top card-product-front" src="public/images/product-8-1.jpg" alt="Card image cap">
                            <img class="card-img-top card-product-back" src="public/images/product-8-2.jpg" alt="Card image cap">
            ...
            <div class="col-md-3">
                    <div class="card-product">
                        <div class="card-product-img">
                            <img class="card-img-top card-product-front" src="public/images/product-9-1.jpg" alt="Card image cap">
                            <img class="card-img-top card-product-back" src="public/images/product-9-2.jpg" alt="Card image cap">
            ...
            <div class="col-md-3">
                    <div class="card-product">
                        <div class="card-product-img">
                            <img class="card-img-top card-product-front" src="public/images/product-10-1.jpg" alt="Card image cap">
                            <img class="card-img-top card-product-back" src="public/images/product-10-2.jpg" alt="Card image cap">
            ...
            <div class="col-md-3">
                    <div class="card-product">
                        <div class="card-product-img">
                            <img class="card-img-top card-product-front" src="public/images/product-11-1.jpg" alt="Card image cap">
                            <img class="card-img-top card-product-back" src="public/images/product-11-2.jpg" alt="Card image cap">
