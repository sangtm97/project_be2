...
$less = new lessc;
$less->compileFile('less/module-15.less', 'css/module-15.css');
?>
    <link href="css/module-15.css" rel="stylesheet" type="text/css" />
        ...
        <nav>
            <div class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
                ...
                <button class="nav-link" id="nav-additional-tab" data-bs-toggle="tab" data-bs-target="#nav-additional"
                    type="button" role="tab" aria-controls="nav-additional" aria-selected="false">
        ...
        <div class="container">
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade" id="nav-additional" role="tabpanel" aria-labelledby="nav-additional-tab">
                    <table class="table product-attributes table-bordered border-dark">
                        <tbody>
                            ...
                            <tr class="product-attributes-item product-attributes-item--attribute_pa_room">
                                <th class="product-attributes-item__label">Room</th>
                                <td class="product-attributes-item__value">
                                    <p>Bath, Kitchen</p>
                                </td>
                            </tr>
                    ...
                    <div id="reviews" class="Reviews text-center">
                        <div id="comments">
                            <h2 class="Reviews-title text-center">
                                Reviews </h2>
                            <p class="noreviews text-center">There are no reviews yet.</p>
                        </div>
                        <div id="review_form_wrapper">
                            <div id="review_form">
                                <div id="respond" class="comment-respond ">
                                    <span id="reply-title" class="comment-reply-title" style="font-size: xx-large;">Be
                                        the first to
                                        review “Highland Bedside Table” </span>

                                    <form action="https://demo4.drfuri.com/razzi9/wp-comments-post.php" method="post"
                                        id="commentform" class="comment-form text-start row g-3" novalidate="">
                                        <p class="comment-notes text-center"><span id="email-notes">Your email address
                                                will not be
                                        ...
                                        <div class="comment-form-rating"><label for="rating">Your rating&nbsp;<span
                                            ...
                                            <p class="stars" style="font-size: 0;"> <span> <a class="star-1"
                                                        href="#"><span class="razzi-svg-icon "
                                                            ...
                                                            </svg></span>1</a> <a class="star-2" href="#"><span
                                                            class="razzi-svg-icon " style="color: black;"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="16"
                                                                height="16" viewBox="0 0 24 24" fill="currentColor">
                                                                <polygon
                                                                    points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2">
                                                                </polygon>
                                                            </svg></span>2</a> <a class="star-3" href="#"><span
                                                            class="razzi-svg-icon " style="color: black;"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="16"
                                                                height="16" viewBox="0 0 24 24" fill="currentColor">
                                                                <polygon
                                                            ...
                                                            </svg></span>3</a> <a class="star-4" href="#"><span
                                                            class="razzi-svg-icon " style="color: black;"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="16"
                                                                height="16" viewBox="0 0 24 24" fill="currentColor">
                                                                <polygon
                                                            ...
                                                            </svg></span>4</a> <a class="star-5" href="#"><span
                                                            class="razzi-svg-icon " style="color: black;"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="16"
                                                                height="16" viewBox="0 0 24 24" fill="currentColor">
                                                                <polygon
                                                            ...
                                                            </svg></span>5</a> </span> </p><select name="rating"
                                                id="rating" required="" style="display: none;">
                                        ...
                                        <p class="comment-form-comment"><label for="comment">Your review&nbsp;<span
                                                ...
                                                name="comment" cols="105" rows="8" required=""></textarea></p>
                                        ...
                                        <p class="form-submit"><input name="submit" type="submit" id="submit"
                                                ...
                                                name="comment_post_ID" value="11831" id="comment_post_ID">
