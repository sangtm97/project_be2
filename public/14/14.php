...
<head>
    ...
    <?php
        ...
        $less = new lessc;
        $less->compileFile('public/less/module-14.less', 'public/css/module-14.css');
        ?>
    <link href="public/css/module-14.css" rel="stylesheet" type="text/css" />
            ...
            <div class="col-md-6">
                <div class="card-product">
                    <div class="card-product-img">
                        <img class="card-img-top card-product-front" src="public/images/product1.jpg"
                            alt="Card image cap">
                    </div>
                </div>
            </div>
