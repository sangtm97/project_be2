                            ...
                            <div id="respond" class="comment-respond ">
                                ...
                                <form action="https://demo4.drfuri.com/razzi9/wp-comments-post.php" method="post"
                                    ...
                                    <div class="comment-form-rating"><label for="rating">Your rating&nbsp;<span
                                        ...
                                        <p class="stars" style="font-size: 0;"> <span> <a class="star-1" href="#"><span
                                                        ...
                                                        </svg></span>5</a> </span> </p><select name="rating" id="rating"
                                    ...
                                    <p class="form-submit"><input name="submit" type="submit" id="submit" class="submit"
                                            value="Submit"> <input type="hidden" name="comment_post_ID" value="11831"
                                            id="comment_post_ID">
