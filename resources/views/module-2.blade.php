            ...
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner" style="width:100%">
                    <div class="carousel-item active">
                        ...
                        <img src="./2/public/images/Home-v13-Slide-1.png" class="d-block w-100" style="width:100%"
                            alt="...">
                    ...
                    <div class="carousel-item">
                        ...
                        <img src="./2/public/images/Home-v13-Slide-2.png" class="d-block w-100" style="width:100%"
                            alt="...">
                    </div>
                </div>
            </div>
