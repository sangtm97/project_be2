            ...
            <div id="recipeCarousel" class="carousel module4 carousel-dark slide" data-bs-ride="carousel">
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <a href="{{route('productDetail',$bestsellers[4]->id)}}">
                                    <div class="card-img">
                                        <img src="./upload/{{$bestsellers[4]->product_image}}" class="img-fluid">

                                        <div class="btn-group" role="group" aria-label="Basic outlined example">
                                            <button type="button" class="btn btn-outline-none add"><span
                                                    class="razzi-svg-icon icon-cart"><svg aria-hidden="true" role="img"
                                                        focusable="false" width="15" height="24" viewBox="0 0 24 24"
                                            ...
                                            <button type="button" class="btn btn-outline-none view"
                                            ...
                                            <button type="button" class="btn btn-outline-none wish"><span
                                                    class="razzi-svg-icon "><svg aria-hidden="true" role="img"
                                                        focusable="false" xmlns="http://www.w3.org/2000/svg" width="15"
                                                        height="24" viewBox="0 0 24 24" fill="none"
                                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            <div class="product-summary text-start">
                                ...
                                <h2 class="product-title"><a href=""></a>{{$bestsellers[4]->product_name}} </h2>
                                <span class="price">${{$bestsellers[4]->product_price}}</span>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item ">
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <a href="{{route('productDetail',$bestseller->id)}}">
                                    <div class="card-img">
                                        <img src="./upload/{{$bestseller->product_image}}" class="img-fluid">
                            ...
                            <div class="product-summary text-start">
                                <a href="" class="meta-cat">Furniture</a>
                                <h2 class="product-title"><a href=""></a>{{$bestseller->product_name}}</h2>
