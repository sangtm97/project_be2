<div class="module-5">
    <div class="container">
        ...
        <h3>Small Space Dining <br>
                 Room Furniture</h3>
            <img src="./5/public/images/home13-banner-3.webp" alt="">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card-product">
                    <div class="card-product-img">
                        <img class="card-img-top card-product-front" src="./5/public/images/home13-categories-1.webp">
                    </div>
            ...
            <div class="col-md-6">
                <div class="card-product2">
                    <div class="card-product-img">
                        <img class="card-img-top card-product-front" src="./5/public/images/home13-categories-2.webp">
                    </div>
                    <div class="category-content">
                    <h4 class="title">Kitchen</h4>
                        <a href="{{url('/listproduct')}}">Bar Tables & Sets</a>
                        <span class="muiten"><svg aria-hidden="true" role="img" focusable="false" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="0" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg></span><br>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card-product3">
                    <div class="card-product-img">
                        <img class="card-img-top card-product-front" src="./5/public/images/home13-categories-3.webp">
                    </div>
                    <div class="category-content">
            ...
            <div class="col-md-6">
                <div class="card-product4">
                    <div class="card-product-img">
                        <img class="card-img-top card-product-front" src="./5/public/images/home13-categories-4.webp">
                    </div>
                    <div class="category-content">
