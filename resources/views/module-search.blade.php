<div class="module-12" style="padding-top:50px">
    <div class="container">
        <h4>Resutl search products:</h4>
                ...
                <div class="card-product">
                    <a href="{{url('/productdetail')}}" style="text-decoration: none;color: #000">
                        <div class="card-product-img">
                            <img class="card-img-top card-product-front" src="./upload/{{$product->product_image}}"
                                alt="Card image cap">
                            <img class="card-img-top card-product-back" src="./upload/{{$product->product_image}}"
                                alt="Card image cap">
                        </div>
                        ...
                        <div class="card-content">
                            <h2 class="card-product-name">{{$product->product_name}}</h2>
                            <p class="card-product-price">&pound; {{$product->product_price}}</p>
                        </div>
                    </a>
                </div>
